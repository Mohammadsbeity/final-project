                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item position-relative {{ ($loop->first) ? 'active': ''}}" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{ asset('image/'.$slide->image) }}" style="object-fit: cover;">
                        </div>
                        @endforeach
                    </div>
                </div>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="{{ route('shop-category', ['id' => $category->id ]) }}">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="{{ asset('image/'.$category->category_icon) }}" alt="">
                        </div>
