                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('favorites') }}" class="nav-item nav-link {{ request()->is('favorites*') ? 'active' : '' }}">Favorites</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="{{ route('favorites') }}"><i class="fa fa-angle-right mr-2"></i>Favorites</a>
                            {{-- <a class="text-secondary mb-2" href="{{ route('about_us') }}"><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a>
                            <a class="text-secondary mb-2" href="{{ route('about_us') }}"><i class="fa fa-angle-right mr-2"></i>Checkout</a> --}}
